...
// 설정 변수 (개발자가 수정)
// ========================================
const SCRIPT_TEXT = "안녕하세요, 저는 필터온에서 딥보이스 체험을 하고 있습니다. 이 목소리가 어떻게 변할지 궁금하네요.";
const DEEPVOICE_TEXT = "안녕하세요, 저는 AI가 만든 가짜 목소리입니다. 놀랍지 않나요? 이렇게 쉽게 목소리를 복제할 수 있습니다.";
...
export default function DeepvoiceEventOverlay({ onClose }: DeepvoiceEventOverlayProps) {
  ...
  const startRecording = useCallback(async () => {
    try {
      ...
      if (error.name === 'NotAllowedError' || error.name === 'PermissionDeniedError') {
        setError({
          title: '마이크 권한 거부됨',
          message: '마이크 사용 권한이 거부되었습니다. 브라우저 설정에서 마이크 권한을 허용해주세요.'
        });
        ...
        {currentScreen === 'record' && (
          <div className="flex flex-col items-center text-center max-w-xl w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-neutral-400 mb-6">
              아래 대본을 읽어주시면 AI가 당신의 목소리를 분석합니다
            </p>
              ...
              <Card className="w-full mb-6 bg-neutral-900 border-neutral-800">
                <CardContent className="p-4">
                  ...
                  <p className="text-neutral-500 text-sm">
                    녹음 버튼을 누르면 브라우저에서 마이크 권한을 요청합니다. "허용"을 선택해주세요.
                  </p>
                </CardContent>
              </Card>
            )}
            ...
            <div className="flex flex-col items-center gap-4 mb-6">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-neutral-400">
                  {isRecording ? '녹음 중...' : hasRecording ? '녹음 완료' : '녹음 대기 중'}
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center text-center max-w-xl w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            >
              <div className="text-neutral-300 leading-relaxed space-y-4">
                <p>
                  <strong className="text-white">어떠신가요?</strong> 이 음성은 AI로 생성된 '딥보이스'(Deep Voice)입니다.
                </p>
                <p>
                  짧게 말한 그 순간, 당신과 비슷한 목소리를 만들어 낼 수 있습니다.
                </p>
                <p>
                  지금 체험해보신 기술이, 실제로는 피싱이나 각종 사기에 악용되는 사례가 늘고 있습니다.
                </p>
                <p>
                  <strong className="text-white">필터온</strong>은 딥보이스 체험뿐만 아니라, 피싱·스미싱 등 디지털 사기 예방 교육을 함께 제공합니다.
                </p>
                <p>
                  방금 느낀 그 놀라움과 위험성을 한순간의 감정으로 끝내지 마세요.
                  <br />
                  조금만 더 관심을 가지고 대비한다면, 앞으로 다가올 더 큰 위험을 막을 수 있습니다.
                </p>
              </div>
            </div>
